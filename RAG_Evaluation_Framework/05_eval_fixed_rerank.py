...
# --- 配置區 ---
EXP_CONFIG = {
    "STRATEGY_NAME": "Fixed_Chunking_RERANK",
    "EMBEDDING_MODEL": "intfloat/multilingual-e5-small",
    "CHUNK_SIZE": 200,
    "CHUNK_OVERLAP": 20,
    "GROUND_TRUTH_PATH": "./output/ai_evidence_report.json",
    "PREDICTION_PATH": "./output/retrieval_results_parent_doc_rerank.json",
    "OUTPUT_REPORT_PATH": "./output/evaluation_full_report_4-4.json",
    "K_VALUES": [1, 3, 5, 8]
}
